...
from utils_dataloaders import fetch_or_load_views_df, create_or_load_volume, parse_args
...
if __name__ == "__main__":
    ...
    if args.calibration:
        ...
        vol_cal = create_or_load_volume('calibration', PATH_RAW, PATH_PROCESSED)
    ...
    if args.testing:
        ...
        vol_test = create_or_load_volume('testing', PATH_RAW, PATH_PROCESSED)
    ...
    if args.forecasting:
        ...
        vol_forecast = create_or_load_volume('forecasting', PATH_RAW, PATH_PROCESSED)
