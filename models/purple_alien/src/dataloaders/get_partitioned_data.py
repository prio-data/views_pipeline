...
if __name__ == "__main__":
    ...
    if args.calibration:
        df_cal = fetch_or_load_views_df('calibration', PATH_RAW, args.saved)
    ...
    if args.testing:
        df_test = fetch_or_load_views_df('testing', PATH_RAW, args.saved)
    ...
    if args.forecasting:
        df_forecast = fetch_or_load_views_df('forecasting', PATH_RAW, args.saved, args.override_month)
