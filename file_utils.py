...
class FileUtils:
    ...
    def create_log_file(path_generated,
        ...
        FileUtils.create_specific_log_file(path_generated, run_type, model_name, deployment_status,
        ...
        if models:
            for m_name in models:
                ...
                log_data = FileUtils.read_log_file(model_path_generated / f"{run_type}_log.txt")
                FileUtils.create_specific_log_file(path_generated, run_type, m_name, log_data["Deployment Status"], 
